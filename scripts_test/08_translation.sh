...
python translate.py -model ../../../nmt-system-D/model/eten_model_acc_70.41_ppl_4.24_e13.pt -src ../../../nmt-system-D/data/bpe.cs-tc-tok-test.et -output ../../../nmt-system-D/data/bpe-tc-tok-D.hyps.test.en -attn_debug -gpu 0
